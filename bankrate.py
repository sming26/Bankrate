...
def process2(features, mort, n_feats, n_weeks, n_valid, n_embed, n_output, lr1=0.01, lr2=0.005, epochs=50, batch_size=52):
    ...
    fit2 = model2.fit(train_X2, train_y2, epochs=50, batch_size=52, validation_data=(test_X2, test_y2), verbose=0, shuffle=False)
...
# one-time training and validation for the three models
